...
namespace taquin
{
  ...
  class Taquin  {
    ...
    private:
      void set_inicial(const unsigned v[]);  //Podrian ser publicas y de esta forma probar distintas configuraciones
      ...
      bool repetido(const Nodo_Taquin&,size_t, const bool amplitud);   // Comprueba si un nodo esta repetido, para no volver a expandirlo
      void inicializar_lista();

      std::vector <Nodo_Taquin> lista;
      unsigned indice_objetivo;  //Indice del arbol en el que se encuentra la solucion
